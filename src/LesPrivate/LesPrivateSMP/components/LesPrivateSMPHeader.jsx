...
const LesPrivateSMPHeader = () => {
  return (
    <section className="centered-content-lesPrivate-smp">
      ...
      <p>
        ...
        Jabodetabek. Bagi siswa yang berada di luar Jabodetabek dan membutuhkan
        layanan guru les privat SMP, Les Privat Matrix dapat melayani dengan
        sistem les privat online via aplikasi video call seperti Zoom, Skype,
        Google Hangout, Google meet, Whatsapp dan aplikasi pendukung lainnya
        yang dimiliki siswa.
      </p>
      ...
      <p className="">
        ...
        Bahasa Inggris, Fisika, Kimia, Biologi, Ekonomi, Bahasa Mandarin, dan
        lain-lain. Sementara itu, untuk les privat SMP kurikulum Nasional
        membahas mata pelajaran Matematika, Bahasa Indonesia, Bahasa Inggris,
      ...
      <p className="">
        ...
        akan lebih siap menghadapi berbagai ujian penting di tingkat SMP.
      </p>
      ...
      <p className="">
        ...
        dan PTN Terbaik. Terseleksi, Berpengalaman & Berkualitas.
      </p>
      <p>
        ...
        menyesuaikan dengan kebutuhan siswa dan metode belajar personal (1 siswa
        1 guru) agar bisa mencapai target belajar yang diinginkan.
      </p>
    </section>
  );
};
