...
const KeunggulanLesPrivateSimakUIList = () => {
  const subjects = [
    "Menggunakan sistem belajar Matrix Tutoring terpola dan terstruktur disesuaikan dengan kurikulum sekolah dan kebutuhan belajar siswa.",
  ...
  return (
    <div className="keunggulan-les-private-UI-list-container">
      <h2>Keunggulan Les Privat Matrix Tutoring</h2>
