  ...
  return (
    <div>
      ...
      <p>
        ...
        rekaman. Kelebihan dari sistem ini antara lain:
      </p>
      <ul>
        <li>
      ...
      <p>
        Matrix menyediakan potongan biaya untuk les privat Online dengan biaya
        yang lebih hemat daripada Privat Offline.
      </p>
    </div>
  );
};
