              ...
              "@graph": [
                {
                  ...
                  "itemListElement": [
                    ...
                    },
                    {
                      ...
                      "position": "4",
                      "item": {
                        "@id": "${baseUrl}/les-privat-sma/${kotaSlug}/${kabupatenSlug}", // URL kabupaten induk
                    ...
                    },
                    {
                      ...
                      "position": "5",
                      "item": {
                        "@id": "${baseUrl}/les-privat-sma/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}", // URL kecamatan induk
