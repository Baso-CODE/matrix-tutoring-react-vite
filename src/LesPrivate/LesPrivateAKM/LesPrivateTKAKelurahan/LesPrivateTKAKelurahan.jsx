...
const LesPrivateTKAKelurahan = () => {
  ...
  const canonicalUrl = `${baseUrl}/les-privat-tka-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}/${kelurahanSlug}`;
  ...
  return (
    <React.Fragment>
              ...
              "@graph": [
                {
                  ...
                  "itemListElement": [
                    ...
                    },
                    {
                      ...
                      "position": "4",
                      "item": {
                        "@id": "${baseUrl}/les-privat-tka-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}",
                    ...
                    },
                    {
                      ...
                      "position": "5",
                      "item": {
                        "@id": "${baseUrl}/les-privat-tka-asesmen-kompetensi-minimum/${kotaSlug}/${kabupatenSlug}/${kecamatanSlug}",
      ...
      <div className="container-all">
        ...
        <section id="program-les-private-matrix">
          <ProgramLesPrivat />
        </section>
        <MasterTeacherV2 />
