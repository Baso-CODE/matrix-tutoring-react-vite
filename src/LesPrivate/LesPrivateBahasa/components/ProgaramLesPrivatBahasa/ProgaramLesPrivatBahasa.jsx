...
const ProgaramLesPrivatBahasa = () => {
  return (
    <section className="container-all">
      <div className="centered__program-bahasa">
        <h2>Program Les Privat Bahasa Asing dan BIPA</h2>
        <p>
          Matrix Tutoring menawarkan program Les Privat Bahasa Asing untuk
          berbagai kebutuhan, mulai dari percakapan sehari-hari hingga persiapan
          ujian internasional:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            ekspatriat, mahasiswa asing, atau pasangan internasional yang ingin
            lancar berbahasa Indonesia.
          </li>
        </ul>
        <p>
          Les Privat bisa dilaksanakan secara <b>offline</b> (guru datang ke
          rumah) maupun <b>online</b> (via Zoom/Google Meet), sesuai dengan
          kebutuhan siswa.
        </p>
        <br />
        <br />
        <h2>
          Les Privat Bahasa Asing – Fleksibel & Efektif untuk Semua Kalangan
        </h2>
        <p>
          ...
          hari libur nasional, semua sangat memungkinkan. Kapan pun Anda siap,
          kami pun siap mendampingi.
        </p>
        <p>
        ...
        <p>
          Khusus Program Les Privat Online, ada keuntungan tambahan untuk Anda:
        </p>
        <ul>
          <li>
          ...
          <li>Belajar bisa dilakukan dari mana saja tanpa batasan lokasi.</li>{" "}
          <li>
        ...
        <p>
          Untuk informasi lengkap mengenai biaya Program Les Privat Bahasa
          Asing, silakan hubungi kami di 085747281466.
        </p>
      </div>
    </section>
  );
